...
function completedServiceTask(intent: RebalancingJobIntent): ServiceTask {
  return {
    serviceTaskId: `service-task:${intent.jobIntentId}`, originKind: "JOB_INTENT", jobIntentId: intent.jobIntentId, findingId: intent.findingId, serviceId: intent.selectedService.serviceId, agentId: intent.selectedService.agentId, category: "rebalancing",
